...
import com.github.stefanbirkner.systemlambda.SystemLambda; // Correct import statement
...
public class APITokenManagerTest {
    ...
    @Test
    public void testEnvVariableValiditySR() { // Using system L

        // ensure system propery is cleared before retreiving env variable
        System.clearProperty("api.currency.token");

        // Java does not allow doesn't allow setting environment variables directly
        // through a specific class or exisiting method - we will need to create a mock
        // environment of this using a library such as System Lambda or System Rules

        // 1. create an instance of EnvironmentVairables and import it
        // 2. set the env variable using System rukles
    ...
    @Test
    public void testEnvVariableValiditySL() throws Exception { // Using SystemLambda
        ...
        SystemLambda.withEnvironmentVariable("API_CURRENCY_TOKEN", "test-api-token-from-env-variable")
                .execute(() -> {
                    System.clearProperty("api.currency.token"); // Ensure system property is cleared before retrieving
                                                                // env variable
